...
#' Obtain mouse bulk expression data (RNA-seq)
#'
#' Download and cache the normalized expression values of 358 bulk RNA-seq samples 
#' generated by Benayoun Lab (Benayoun et al., 2019).
#'
#' @details This data set was contributed by the Benayoun Lab; it was generated
#' as part of a detailed study of aging mice and the corresponding changes of 
#' their transcriptomes and epigenomes (Benayoun et al., 2019).
#' The samples were obtained from heart, liver, cerebellum, olfactory bulb, and
#'  primary cultures of neural stem cells of C57BL/6N male mice at three different
#'  time points: youth (3 mo), middle age (12 mo), and old age (29 mo).
#' 
#' The dataset entails 358 mouse RNA-seq samples annotated to 18 main cell types: 
#' Adipocytes, Astrocytes, B cells, Cardiomyocytes, Dendritic cells, Endothelial cells, Epithelial cells, Erythrocytes, Fibroblasts, Granulocytes, Hepatocytes, Macrophages, Microglia, Monocytes, Neurons, NK cells, Oligodendrocytes, T cells.
#' 
#' @return A \linkS4class{SummarizedExperiment} object where \code{assay(..., "normcounts")}
#' contains the normalized expression values and \code{colData()} can be used to 
#' extract the cell type labels of every sample.
