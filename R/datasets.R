...
HumanPrimaryCellAtlasData <- function(ensembl=FALSE) {
    version <- "1.0.0"
...
#' Altogether, this reference contains 259 samples with 43 cell types.
#' 
...
#'
#' @export
BlueprintEncodeData <- function(rm.NA = c("rows","cols","both","none"), ensembl=FALSE) {
    version <- "1.0.0"
...
#' 
#' @export
ImmGenData <- function(ensembl=FALSE) {
    version <- "1.0.0"
...
#' 
#' @export
MouseRNAseqData <- function(ensembl=FALSE) {
    version <- "1.0.0"
...
#' 
#' @export
DatabaseImmuneCellExpressionData <- function(ensembl=FALSE) {
    version <- "1.0.0"
...
#' 
#' @export
NovershternHematopoieticData <- function(ensembl=FALSE) {
    version <- "1.0.0"
...
#' 
#' @export
MonacoImmuneData <- function(ensembl=FALSE) {
    version <- "1.0.0"
...
.convert_to_ensembl <- function(se, species) 
