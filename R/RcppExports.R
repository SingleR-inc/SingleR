...
find_classic_markers <- function(nlabels, ngenes, left, right, ref, available, de_n, nthreads) {
    .Call('_SingleR_find_classic_markers', PACKAGE = 'SingleR', nlabels, ngenes, left, right, ref, available, de_n, nthreads)
}
