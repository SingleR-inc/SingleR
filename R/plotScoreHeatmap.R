...
#' @param calls.use Integer scalar specifying which labels to use, defaulting to those from the top-level \code{results} which is indicated by the value 0.
...
#' @param show.labels Logical indicating whether the chosen labels of cells should be shown as an annotation bar.
#' @param show.pruned Logical indicating whether the pruning status of the cell labels, as defined by \code{\link{pruneScores}}, should be shown as an annotation bar.
