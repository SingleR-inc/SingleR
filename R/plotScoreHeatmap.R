...
#' 
#' Note for \code{annotation_col}: Use this to add extra annotations. Clustering, pruning, and labels annotations are automatically generated and appended when appropriate.
#'
