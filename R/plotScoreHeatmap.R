    ...
    silent = FALSE, ..., grid.vars = list())
{
    ...
    scores <- .trim_normalize_reorder_scores(
        scores, scores.title, labels.use, max.labels, cells.use, normalize,
