...
author: Friederike Düendar
date: "Revised: Auguest 13, 2019"
output:
...
The [legacy SingleR package](https://github.com/dviraran/SingleR/tree/master/data) provides RDA files for `immgen`, `mouse.rna.seq`, `blueprint_encode` and `hpca`.
...
## Mouse bulk RNA-seq samples of pure cell populations
