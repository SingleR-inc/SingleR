...
date: "Revised: November 9th, 2019"
output:
...
In many cases, running the test set against multiple reference datasets may be useful. 
The `combineResults` function will pool multiple predictions together and select the label with the highest score between them for each cell/cluster:
