...
The aim will be to use one pre-labelled dataset to annotate the other unlabelled dataset.
...
For the sake of speed, we will subset the @grun2016denovo dataset to the first 100 cells in this demonstration.
...
```{r}
# Obtain a human ESC dataset (subsetting for speed).
