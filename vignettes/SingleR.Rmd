...
The `combineResults` function will pool multiple predictions together and retain the data from the prediction with the highest score for each cell/cluster:
