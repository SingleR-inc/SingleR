---
title: "Obtaining mouse reference data from the Immunological Genome Project"
...
# Removing a NA row name.
logcounts <- logcounts[!is.na(rownames(logcounts)),,drop=FALSE]
```
