df <- data.frame(
    ...
    Description = sprintf("%s 211 microarray samples of hematopoietic cells generated by Differentiation Map", 
    ...
    SourceUrl="https://www.dropbox.com/sh/38zlauhoh4tlrev/AACwTS9L7KmGIp-3jolsykxea?dl=0",
    SourceVersion="dmap.rda",
